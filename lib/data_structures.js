...
var _doubly_linked_list_node = __webpack_require__(3);
  ...
  _createClass(DoublyLinkedList, [{
    ...
    value: function includes(value) {
      ...
      this.forEach(function (node) {
        if (_this._comparisonCb(node, comparisonNode)) found = true;
      });
      return found;
    }
  }, {
    ...
    key: '_addInitialValues',
    value: function _addInitialValues(values) {
      var _this2 = this;
...
var HashMap = function () {
  function HashMap() {
    ...
    this._validateInput(params);
    params = Object.assign({ values: null, keyGenerator: function keyGenerator(value) {
        return value;
      } }, params);
  ...
  _createClass(HashMap, [{
    ...
    value: function createKey(value) {
      ...
      var processedValue = this._keyGenerator(value);
      var key = hash.update(JSON.stringify(processedValue)).digest('hex');
    ...
    value: function _validateInput(params) {
      if (!((0, _isPlainObject2.default)(params) || params === null)) {
        ...
        var valuesError = new TypeError('values should be an array or null.');
        var keyGeneratorError = new TypeError('keyGenerator should be a Function or null.');
...
var _doubly_linked_list = __webpack_require__(2);
...
var _hash_map = __webpack_require__(4);
...
var Cache = function () {
  function Cache() {
    ...
    var params = Object.assign({ capacity: Infinity, values: null }, options);
    ...
    params.keyGenerator = function (value) {
      if (value instanceof _doubly_linked_list_node2.default) value = value.value;

      return options.keyGenerator !== undefined ? options.keyGenerator(value) : value;
    };

    this._hashMap = new _hash_map2.default({ keyGenerator: params.keyGenerator });
  ...
  _createClass(Cache, [{
    ...
    value: function _validateInput(params) {
      ...
      if (values !== undefined && !(0, _isArray2.default)(values)) throw valuesError;
      if (capacity !== undefined) {
        if (!(0, _isInteger2.default)(capacity)) throw capacityTypeError;
